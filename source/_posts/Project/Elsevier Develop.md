---
title: Elsevier Develop
date: 2025-02-17 11:17:35
tags:
  - 
categories: Project
---

[Elsevier Developer Portal api_key_settings](https://dev.elsevier.com/api_key_settings.html)
...
[ElsevierDev/elsapy: A Python module for use with Elsevier's APIs: Scopus, ScienceDirect, others.](https://github.com/ElsevierDev/elsapy)
...
# els_search = ElsSearch(search_query, 'scopus')
els_search = ElsSearch(search_query, 'sciencedirect')
els_search.execute(client)

print ("URI:", els_search.uri)
print ("totalResults:", els_search.total_results)
print ("results:", len(els_search.results))
