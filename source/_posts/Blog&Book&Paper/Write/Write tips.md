[Leey21/awesome-ai-research-writing: Elevate your AI research writing, no more tedious polishing ✨](https://github.com/Leey21/awesome-ai-research-writing) AI学术写作提示词
...
翻译成中文，并保持文章的结构不变，尽可能精简语句使其更加易读。重点关注：
1. 取消引言中所有参考文献的引用，总结提炼为几段话
2. 减少英文缩写的使用，尽量使用中文全称
3. 保证方法部分的公式完整
4. 精简算例部分的说明和结论，并将图题，表题翻译成中文。但保证图片和表格完整
5. 取消公式后面的编号\tag {xxx}
6. 结论后的附录、参考文献等部分不用翻译
